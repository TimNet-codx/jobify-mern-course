...
export const validateUpdateUserInput = withValidationErrors([
    ...
    .custom(async (email, {req}) =>{
        const user = await User.findOne({email})
        // Checking if the email is you and  is other email that already exist in DB, if is the sane email with current user no error, but if the email is for other user that exit DB throw Error 
